...
**Desarrollador full stack** · aplicaciones web, APIs e integraciones
...
Construyo productos **de punta a punta**: frontend, backend, bases de datos, paneles admin e **integraciones con servicios externos** (pagos, POS, IA, WhatsApp).

Me gusta el código **legible**, los README claros y los proyectos que se pueden **mostrar y usar**, no solo tutoriales.
...
![MapTiler](https://img.shields.io/badge/MapTiler-333?style=for-the-badge&logo=mapbox&logoColor=white)
...
![Windows](https://img.shields.io/badge/Windows_Service-0078D4?style=for-the-badge&logo=windows&logoColor=white)
...
| | |
|:---|:---|
| 🎯 | Producto usable y mantenible |
| 📦 | Monorepos y workspaces cuando el proyecto lo pide |
| 🔒 | Auth, validación (Zod) y buenas prácticas básicas |
| 📖 | Documentación en README para quien clone el repo |
| ⚡ | Rendimiento y UX en tienda y paneles admin |
